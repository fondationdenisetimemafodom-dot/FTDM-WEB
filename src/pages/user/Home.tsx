        ...
        >
          <div>
            ...
            >
              <NavLink
                to="/donate"
                className="flex items-center justify-center bg-main-500 w-full md:w-28 lg:w-50 px-4 py-2 text-white text-xl font-semibold rounded-[12px] hover:cursor-pointer hover:vibrate"
              >
              ...
              {/* <button
                ...
                className="border-[3px] border-main-500 py-2 px-6 w-full text-main-500 text-xl font-semibold rounded-[12px] hover:cursor-pointer hover:vibrate"
              >
